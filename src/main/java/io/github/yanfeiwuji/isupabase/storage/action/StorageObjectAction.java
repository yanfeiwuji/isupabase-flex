package io.github.yanfeiwuji.isupabase.storage.action;
...
import io.github.yanfeiwuji.isupabase.storage.entity.StorageObject;
import io.github.yanfeiwuji.isupabase.storage.ex.StorageExFactory;
import io.github.yanfeiwuji.isupabase.storage.mapper.StorageObjectMapper;
import io.github.yanfeiwuji.isupabase.storage.provider.S3Provider;
import io.github.yanfeiwuji.isupabase.storage.service.BucketService;
import io.github.yanfeiwuji.isupabase.storage.vo.*;
...
public class StorageObjectAction {
    ...
    @PostConstruct
    public void init() {
        this.storageUpdateSignedJwtExp = properties.getStorageUpdateSignedJwtExp();
    }
