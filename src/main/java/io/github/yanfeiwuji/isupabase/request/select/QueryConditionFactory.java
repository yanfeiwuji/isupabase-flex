...
public class QueryConditionFactory {
    ...
    public static final Map<String, String> ALLOW_MODIFIERS =
            Stream.of("eq", "like", "ilike", "gt", "gte", "lt", "lte", "match", "imatch")
                    .collect(Collectors.toMap(it -> it, it -> it));

    // QueryColumn queryColumn, String value
    // default single
    public static final Map<String, BiFunction<QueryColumn, String, QueryCondition>> OP_BIFUNC_MAP =
            MapUtil.<String, BiFunction<QueryColumn, String, QueryCondition>>builder()
    ...
    private QueryCondition handler(QueryColumn queryColumn, String value, String op, String modifier) {
        ...
        BiFunction<QueryColumn, String, QueryCondition> biFunction =
                Optional.ofNullable(OP_BIFUNC_MAP.get(op)).orElseThrow(() -> new RuntimeException());
    ...
    private static QueryCondition isdistinct(QueryColumn queryColumn, String value) {
        return QueryCondition.create(queryColumn, CommonStr.ISDISTINCT_SQL_OP, ValueUtils.singleValue(queryColumn, value));
    }
